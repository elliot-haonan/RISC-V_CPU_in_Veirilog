...
#
# Generated by export_simulation on Fri Jan 01 23:40:34 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './DataMemory.sh' script.

./DataMemory.sh -reset_run
...
./DataMemory.sh -noclean_files

For more information on the script, please type './DataMemory.sh -help'.
